...
> ```
> - In a CP4BA environment, the authentication can be performed using a [Zen API key](https://www.ibm.com/docs/en/cloud-paks/cp-biz-automation/26.0.0?topic=access-using-zen-api-key-authentication). To do so:
